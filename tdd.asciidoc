...
Ejemplo
~~~~~~~
Veamos un ejemplo de TDD a nivel unitario. Supongamos que estamos desarrollando una aplicación que necesita procesar cadenas de caracteres que representan información tabular mediante barras verticales. En TDD, empezamos con una prueba:
