...
un hábito que se realice casi sin darnos cuentas.
...
(Bloque de ejemplo con una ejecución de construcción automatizada con Maven)
...
(Mostrar pantalla de tests de un proyecto en Jenkins o la salida de los tests
lanzados automáticamente por Maven)
