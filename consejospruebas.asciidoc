...
En este caso, el hincapié está en que tenemos que escribir infraestructura y
herramientas para hacer nuestro trabajo más fácil. Las pruebas no son una
necesidad molesta a la que tenemos que dedicar el menor tiempo posible: son
parte integrante del proyecto, y como tal un ciudadano de primera clase que se
merece tiempo de diseño y de creación de herramientas.
