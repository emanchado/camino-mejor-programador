...
* Requiere más esfuerzo mental al escribir y mantener las pruebas, porque
  tenemos que pensar en los casos posibles.
...
sobre la ejecución o resultados de las pruebas debe ser eliminada.
