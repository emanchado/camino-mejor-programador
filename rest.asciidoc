Diseño de servicios REST con HTTP
=================================
...
En este artículo el autor se ha cuidado mucho de que no haya código. La razón es sencilla, extractos de código ya hay muchos por la web, mientras que explicaciones sobre como es un diseño de servicios REST no hay tantos. El objetivo de este artículo es este último, que el lector se introduzca al mundo del diseño de servicios REST independientemente de la tecnología que use, al fin y al cabo los servicios web deberían ser interoperables y por ende el detalle de que en tecnología están implementados no es realmente importante. Por otro lado las herramientas y frameworks de moda pasan y caducan rápidamente, mientras que las buenas ideas y los conceptos fundamentales de diseño de software perduran. REST es una de esas buenas ideas, documentada allá por el año 2000, todavía no ha perdido ni un ápice de su vigencia.
...
Consultas autodescubriles como enlaces dentro la colección /libro/oferta, /libro/scifi
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Consultas como páginas
^^^^^^^^^^^^^^^^^^^^^^

(TODO
paginas sencillas: "more content link"
paginas complejas: total count, count in page, next, prev, first, last)
