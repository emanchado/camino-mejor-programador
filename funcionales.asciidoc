...
# Obtener una versión todo en mayúsculas de las palabras de la lista
...
superior, los métodos disponibles en Javascript dejan un poco que desear. Una
de las posibilidades es usar el paquete «Valentine».
